            ...
            Container(
                ...
                child: Column(
                    ...
                    children: [
                      TextWidget(
                          text:
                              "\u2022 This estimator is based on the Weech's formula.\n"),
                      TextWidget(
                          text:
                              "\u2022 It is valid for ages between 3months and 12years.\n"),
                      TextWidget(
                          text: "\u2022 Enter age in 'years + months' format."),
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    validator: Validators.compose([
                      Validators.required('required: put 0 if not applicable'),
  ...
  void displayInputError() {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("Alert"),
            content: Text("This calculator is valid for ages between 3months and 12years only."),
            actions: <Widget>[
