...
class PaedDailyMaintenance extends StatelessWidget {
  @override
...
//saving form after validation
        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              Text(
                "\u2022 For neonates (0-28days or <3.5kg), provide age (in days) .\n",
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 12.0,
                  fontStyle: FontStyle.italic,
                  ...
                  SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      validator: Validators.compose([
                        ...
                        //Validators.max(28, 'breakdown into yrs+months format'),
                      ]),
                    ),
                  ),
  ...
  /*void verifyInputSetMessage() {
    final double _weight = double.tryParse(_weightController.value.text);
    final int ageInDays = int.tryParse(_ageController.value.text);
    if (_weight <3.5 && _ageInDays == null){ _message='input age (in days)';}
    //else {calculateFluid();}
  }*/

  /*void displayErrorMessage(BuildContext context) {
    showDialog(
      context: context,
  ...
  /*void displayMessageOrNot(){
    if (_message != null){displayErrorMessage(context);}
    //else {}
  }*/
