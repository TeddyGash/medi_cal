...
class AdultSurgicalAbdomen extends StatelessWidget {
  @override
...
class _InputFieldsState extends State<InputFields> {
  ...
  final _ongoingDrainsController = TextEditingController();
...
//saving form after validation
            ...
            children: [
              ...
              Text(
                "ON-GOING LOSSES: Estimate how much fluid was lost through diarrhoea"
                    ", vomiting, NG Tube, Abdominal drain within the past 24h "
                ...
                children: [
                  SizedBox(
                    ...
                    child: TextFormField(
                      keyboardType:
                      TextInputType.numberWithOptions(decimal: false),
                      decoration: InputDecoration(labelText: 'NG tube/abdominal drain *'),
                      controller: _ongoingDrainsController,
                      validator: Validators.compose([
                        Validators.required('Required. Put 0 if N/A.'),
                        Validators.min(0, "invalid volume"),
                        //Validators.max(12, 'valid only up to 12yrs'),
  ...
  void calcOngoing(){
    ...
    final double _ongoingDrains = double.tryParse(_ongoingDrainsController.value.text);
    _totalOngoing = _ongoingDiarrhoea + _ongoingVomitus + _ongoingDrains;
  }
